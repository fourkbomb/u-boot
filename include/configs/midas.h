...
/* All boards have at least 1GB of DRAM */
#define CONFIG_NR_DRAM_BANKS 4
#define CONFIG_SYS_SDRAM_BASE 0x40000000
#define SDRAM_BANK_SIZE (256 << 20) /* 256MB */
...
#define CONFIG_SPL_TEXT_BASE 0x02023400 /* address that BL1 loads SPL to */
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"readfitbootargs=fdt addr 0x50000000; fdt get value newargs / cmdline && setenv bootargs ${bootargs} ${newargs}\0" /* read bootargs from FIT (used by Android build system) */ \
