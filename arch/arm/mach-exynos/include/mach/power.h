...
struct exynos4412_power {
	...
	unsigned int	arm_l2_0_configuration;
	unsigned int	arm_l2_0_status;
	unsigned int	arm_l2_0_option;
	unsigned char	res43[0x14];
	unsigned int	arm_l2_1_configuration;
	unsigned int	arm_l2_1_status;
	unsigned int	arm_l2_1_option;
